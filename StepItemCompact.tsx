...
const StepItemCompact: React.FC<Props> = ({ step, index, onUpdate, onMoveUp, onMoveDown, onDuplicate, onRemove, onAttach }) => {
  ...
  return (
    <div className="step-compact-root">
      ...
      >
        ...
        {/* Step Number */}
        <span className="step-number-compact">{expanded ? '▼' : '▶'} Step {index + 1}</span>
          ...
          <div>
            ...
            <div className="attachment-row">
              <label className="attachment-add">
                📎 Add File
                <input type="file" className="file-input-hidden" onChange={(e) => handleAttachmentChange(e.target.files?.[0] ?? null)} />
              </label>
              {hasAttachment && (
                <>
