  ...
  return (
    <aside className={`sidebar ${collapsed ? 'collapsed' : ''}`} id="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        <NavLink to="/app/team-tests" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}><span className="nav-item-icon">👥</span> <span>My Test Case</span></NavLink>
        ...
        <NavLink to="/app/test-suite-add" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}><span className="nav-item-icon">🗂️</span> <span>Add to Test Suite</span></NavLink>
